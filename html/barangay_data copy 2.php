...
$purok = isset($_GET['purok']) && in_array($_GET['purok'], $allowedPuroks) ? $_GET['purok'] : 'purok 2';
...
$filters = [
    ...
    'registered_voter' => isset($_GET['registered_voter']) ? 1 : 0,
    'solo_parent' => isset($_GET['solo_parent']) ? 1 : 0,
    'disability' => isset($_GET['disability']) ? 1 : 0,
    'senior_citizen' => isset($_GET['senior_citizen']) ? 1 : 0,
    'family_planning' => isset($_GET['family_planning']) ? 1 : 0,
    'fourPs_member' => isset($_GET['fourPs_member']) ? 1 : 0,
    'pregnant' => isset($_GET['pregnant']) ? 1 : 0,
...
// $searchResults = $db->query_Search($searchQuery, $offset, $itemsPerPage,$purok);
$searchResults = $db->query_Search($searchQuery, $offset, $itemsPerPage, $purok, $filters);

// Get the total number of rows matching the search query for pagination
$totalRows = $db->query_Count($searchQuery,$purok, $filters);
...
<!-- Search Form -->
<form method="GET" action="" class="mb-3 p-3 border rounded bg-light">
    ...
    <button class="btn btn-secondary mb-3" type="button" id="filterToggleBtn">
        Show Filters
    </button>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-check">
                    <input type="checkbox" name="registered_voter" class="form-check-input" id="registeredVoterFilter">
                    <label class="form-check-label" for="registeredVoterFilter">Registered Voter</label>
                </div>
                <div class="form-check">
                    <input type="checkbox" name="solo_parent" class="form-check-input" id="soloParentFilter">
                    <label class="form-check-label" for="soloParentFilter">Solo Parent</label>
                </div>
                <div class="form-check">
                    <input type="checkbox" name="disablity" class="form-check-input" id="disabilityFilter">
                    <label class="form-check-label" for="disabilityFilter">Disability</label>
                </div>
            </div>

            <div class="col-md-4">
                <div class="form-check">
                    <input type="checkbox" name="senior_citizen" class="form-check-input" id="seniorCitizenFilter">
                    <label class="form-check-label" for="seniorCitizenFilter">Senior Citizen</label>
                </div>
                <div class="form-check">
                    <input type="checkbox" name="family_planning" class="form-check-input" id="familyPlanningFilter">
                    <label class="form-check-label" for="familyPlanningFilter">Family Planning</label>
                </div>
                <div class="form-check">
                    <input type="checkbox" name="4ps_member" class="form-check-input" id="fourPsMemberFilter">
                    <label class="form-check-label" for="fourPsMemberFilter">4P's Member</label>
                </div>
            </div>

            <div class="col-md-4">
                <div class="form-check">
                    <input type="checkbox" name="pregnant_or_breastfeeding" class="form-check-input" id="pregnantFilter">
                    <label class="form-check-label" for="pregnantFilter">Pregnant/Breast Feeding</label>
                </div>
                <div class="form-check">
                    <input type="checkbox" name="garage" class="form-check-input" id="garageFilter">
                    <label class="form-check-label" for="garageFilter">Garage</label>
                </div>
            </div>
        </div>
    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        var filters = new bootstrap.Collapse(document.getElementById("filters"), { toggle: false });
...
<!-- Bootstrap JS (needed for collapse feature) -->
