...
<body>
    ...
    <script>
        $(document).on('click', '.deleteBtn', function() {
            ...
            var data_hash = $(this).data('data_hash'); // Get the ID of the row to delete

            // Ask for reason first
            Swal.fire({
                title: 'Reason for Deletion',
                input: 'text',
                inputLabel: 'Please enter a reason for deleting this entry:',
                        ...
                        if (confirmResult.isConfirmed) {
                            ...
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    data_hash: data_hash,
                                    modalStatus: 'delete',
                                    reason: reason // Include the reason in POST data
                                },
                                success: function(response) {
